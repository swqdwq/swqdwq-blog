...
export const siteConfig: SiteConfig = {
	title: "swqdwq",
	subtitle: "a private blog",
	siteURL: "https://swqdwq.com/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "617385", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/swqdwq",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/106394440",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/aaa.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "swqdwq",
